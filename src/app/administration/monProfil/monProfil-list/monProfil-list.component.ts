...
@Component({
    selector: 'app-monprofil-list',
    templateUrl: './monProfil-list.component.html',
    styleUrls: ['./monProfil-list.component.scss'],
})
export class ProfilListComponent extends BaseComponent implements OnInit, OnDestroy {
    ...
    viewProfil( event: any ) {
        this.router.navigate( ['/monProfil/view', event.id], { queryParams: { b_: 1 } });
    }
