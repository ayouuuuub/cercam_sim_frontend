...
import { IMyCalendarDay, IMyCalendarViewChanged, IMyDate, IMyDateRange, IMyDayLabels, IMyInputAutoFill, IMyInputFieldChanged, IMyInputFocusBlur, IMyMarkedDate, IMyMarkedDates, IMyMonth, IMyMonthLabels, IMyOptions, IMyWeek } from "./interfaces/index";
...
export class MyDatePicker implements OnChanges, ControlValueAccessor {
    ...
    @Output() dateChanged: EventEmitter<Object> = new EventEmitter<Object>();
    ...
    setOptions(): void {
        ...
        if ( this.disable !== undefined ) {
            this.opts.componentDisabled = this.disable;
        }
    ...
    onUserDateInput( value: string ): void {
        ...
        if ( value.length === 0 ) {
            ...
            const date: IMyDate = this.utilService.isDateValid( value, this.opts.dateFormat, this.opts.minYear, this.opts.maxYear, this.opts.disableUntil, this.opts.disableSince, this.opts.disableWeekends, this.opts.disableDays, this.opts.disableDateRanges, this.opts.monthLabels, this.opts.enableDays );
    ...
    writeValue( value: any ): void {
        if ( typeof value === 'string' ) {
            if ( value != '' ) {
                ...
                const updDate: IMyDate = { year: date.getFullYear(), month: date.getMonth() + 1, day: date.getDate() };
                this.updateDateValue( updDate, false );
            }
        }
