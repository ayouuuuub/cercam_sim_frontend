...
const PREVMONTH = '.header tr td:first-child div .headerbtncell:first-child .headerbtn';
const NEXTMONTH = '.header tr td:first-child div .headerbtncell:last-child .headerbtn';
const PREVYEAR = '.header tr td:last-child div .headerbtncell:first-child .headerbtn';
const NEXTYEAR = '.header tr td:last-child div .headerbtncell:last-child .headerbtn';
...
describe('MyDatePicker', () => {
    ...
    it('select current day from the selector and clear', () => {
        ...
        fixture.detectChanges();
        const markcurrday = getElement('.markcurrday');
    ...
    it('select today button', () => {
        ...
        fixture.detectChanges();
        const today = getElement('.headertodaybtn');
    ...
    it('select previous year', () => {
        ...
        fixture.detectChanges();
        const prevyear = getElement(PREVYEAR);
        expect(prevyear).not.toBe(null);

        prevyear.nativeElement.click();
        fixture.detectChanges();
        const yearLabel = getElement('.headeryeartxt .headerlabelbtn');
    ...
    it('select next year', () => {
        ...
        fixture.detectChanges();
        const nextyear = getElement(NEXTYEAR);
    ...
    it('test calendar year 2016 month one by one - next month button', () => {
        ...
        const beginDate: Array<string> = ['28', '1', '29', '28', '25', '30', '27', '1', '29', '26', '31', '28'];
        const endDate: Array<string> = ['7', '13', '10', '8', '5', '10', '7', '11', '9', '6', '11', '8'];

        let i = 0;
        do {
            fixture.detectChanges();
            const currmonth = getElements('.caltable tbody tr td');
    ...
    it('options - dayLabels', () => {
        ...
        fixture.detectChanges();
        const ths = getElements('.caltable thead tr th');
    ...
    it('options - monthLabels', () => {
        ...
        for(let i = 1; i <= 12; i++) {
            fixture.detectChanges();
            const monthLabel = getElement('.headermonthtxt .headerlabelbtn');
    ...
    it('options - date format', () => {
        ...
        fixture.detectChanges();
        const invaliddate = getElement('.invaliddate');
    ...
    it('options - today button text', () => {
        ...
        fixture.detectChanges();
        const headertodaybtn = getElement('.headertodaybtn span:last-child');
        expect(headertodaybtn).not.toBe(null);
    ...
    it('options - first day of week', () => {
        ...
        fixture.detectChanges();
        const first = getElement('.caltable thead tr th:first-child');
        expect(first).not.toBe(null);
        expect(first.nativeElement.textContent).toBe('Tue');

        const last = getElement('.caltable thead tr th:last-child');
    ...
    it('options - mark current month', () => {
        ...
        fixture.detectChanges();
        const markcurrmonth = getElement('.markcurrmonth');
    ...
    it('options - mark current year', () => {
        ...
        fixture.detectChanges();
        const markcurryear = getElement('.markcurryear');
    ...
    it('options - month selector', () => {
        ...
        fixture.detectChanges();
        const montlabel = getElement('.headermonthtxt .headerlabelbtn');
        ...
        fixture.detectChanges();
        const monthcell = getElements('.monthcell');
        ...
        fixture.detectChanges();
        const selectedmonth = getElement('.selectedmonth');
    ...
    it('options - year selector', () => {
        ...
        fixture.detectChanges();
        const yearcell = getElements('.yearcell');
        ...
        fixture.detectChanges();
        const selectedyear = getElement('.selectedyear');
    ...
    it('options - min year', () => {
        ...
        fixture.detectChanges();
        const headerbtndisabled = getElement('.headerbtndisabled');
        expect(headerbtndisabled).not.toBe(null);
    });
    ...
    it('options - disable until', () => {
        ...
        fixture.detectChanges();
        const disabled = getElements('tr .disabled');
        ...
        const lastDisabled = disabled[disabled.length - 1];
        ...
        fixture.detectChanges();
        const selectableDays = getElements('.tablesingleday');
    ...
    it('options - enable disabled days one by one', () => {
        ...
        fixture.detectChanges();
        const alldates = getElements('.caltable .daycell');
        expect(alldates).not.toBe(null);
        expect(alldates.length).toBe(42);

        fixture.detectChanges();
        const firstEnabled = alldates[10];
    ...
    it('options - disable weekends', () => {
        ...
        const secondDisabled = disabled[1];
    ...
    it('options - inline', () => {
        ...
        fixture.detectChanges();
        const selectiongroup = getElement('.selectiongroup');
    ...
    it('options - allowSelectionOnlyInCurrentMonth', () => {
        ...
        fixture.detectChanges();
        const selection = getElement('.selection');
        const daycell = getElements('.daycell');
    ...
    it('locale - use fr locale', () => {
        ...
        fixture.detectChanges();
        const days = getElements('.caltable thead tr th');
        ...
        fixture.detectChanges();
        const firstDayOfWeek = getElement('.caltable thead tr th:first-child');
        expect(firstDayOfWeek).not.toBe(null);
        expect(firstDayOfWeek.nativeElement.textContent).toBe('Lun');

        fixture.detectChanges();
        const highlight = getElements('.highlight');
        expect(highlight).not.toBe(null);
        expect(highlight.length).toBe(6);
    ...
    it('selDate - initially selected date - string', () => {
        ...
        fixture.detectChanges();
        const selectedday = getElement('.selectedday div span');
        expect(selectedday).not.toBe(null);
    ...
    it('selDate - initially selected date - object', () => {
        const date: Object = {year: 2017, month: 10, day: 11};
        comp.selectedDate = comp.parseSelectedDate(date);
