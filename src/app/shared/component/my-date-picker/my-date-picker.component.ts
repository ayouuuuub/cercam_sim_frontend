import { ChangeDetectorRef, Component, ElementRef, EventEmitter, forwardRef, Input, OnChanges, OnDestroy, Output, SimpleChanges, ViewChild, ViewEncapsulation } from "@angular/core";
import { ControlValueAccessor, NG_VALUE_ACCESSOR } from "@angular/forms";
import { LocaleService, UtilService } from ".";
import { IMyCalendarDay, IMyCalendarMonth, IMyCalendarViewChanged, IMyCalendarYear, IMyDate, IMyDateFormat, IMyDateModel, IMyDateRange, IMyDayLabels, IMyInputFieldChanged, IMyInputFocusBlur, IMyMarkedDate, IMyMarkedDates, IMyMonth, IMyMonthLabels, IMyOptions, IMyWeek } from "./interfaces/index";
...
export class MyDatePicker implements OnChanges, ControlValueAccessor, OnDestroy {
    ...
    updateDateValue(date: IMyDate): void {
        const clear = !this.utilService.isInitializedDate(date);
    ...
    parseSelectedDate(selDate: any): IMyDate {
        ...
        if (typeof selDate === "string") {
            ...
            const dateValue: Array<IMyDateFormat> = this.utilService.getDateValue(sd, df, delimeters);
